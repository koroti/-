	...
	<div class="checkContentMidele">
		<div class="checkCon perInfo">
			...
			<form class="infoBox" action="editAction.php" method="post">
				<table>
					<tr class="infoTr">
						<th class="thLeft">学号:</th>
						<th class="thRight"><?php echo $data['sid'];?></th>
					</tr>
					<tr class="infoTr">
						<th class="thLeft">姓名:</th>
						<th class="thRight"><?php echo $data['sname'];?></th>
					</tr>
					<tr class="infoTr">
						<th class="thLeft">出生日期:</th>
						<th class="thRight"><input type="text" name="birth" value="<?php echo $data['birthday'];?>"/></th>
					</tr>
					<tr class="infoTr">
					...
					<tr class="infoTr">
						...
						<th class="thRight"><input type="text" name="tele" autocomplete="off" value="<?php echo $data['telephone'];?>"/></th>
					</tr>					
					<tr class="infoTr">
				...
				<input type="submit" id="edit" name="Submit" value="提交"/>
			</form>
		</div>
	</div>
</div>
