...
date_default_timezone_set('Asia/Shanghai');
    ...
    include 'conn.php';
    $sql = "call show_signIn_$user('$id','$cid')";
...
<div class="checkWorkContent clearfix">
    <div class="checkTop clearfix">
        ...
        <div class="checkNav">
            <ul>
                ...
                <li class="navLi2">
                   <b></b><a href="studentCourse.php">我的课表</a>
                </li>
                <li class="navLi3">
    ...
    <div class="checkConMiddle">
        ...
        <div class="rightBox">
            ...
            ?>
            <div class="user-attendanceR-list ">
                <div class="user-attendanceR-detail" style="width: 300px;">
                    <?php for($i = 0; $i < $num ; $i++) { ?>
                       <span class="time"><?php echo $row[$i];?></span>
                    <?php }?>
                    <a href="attendanceRecord.php?cid=<?php echo $row['cid'];?>" target="_blank" class="btn-attendance">考勤记录</a>
                </div>
            </div>
            <?php }?>
        </div>
