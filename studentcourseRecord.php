...
date_default_timezone_set('Asia/Shanghai');
    ...
    include 'conn.php';
    $sql = "show_signIn_student('$id','$cid')";
...
<style type="text/css">
    ...
    .user-attendanceR-detail .time{display:inline-block;width:200px; text-align: center;}
		...
		<div class="rightBox">
			<div class="user-attendanceR-list">
				<div class="user-attendanceR-detail">
                    ...
                    <span class="time">考勤情况</span>
				</div>
			</div>
			<?php
                include 'conn.php';
                $sql = "call show_signIn_student('$id','$cid')";
                $result=mysqli_query($mysql, $sql);
