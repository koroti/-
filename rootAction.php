...
<style type="text/css">
    ...
    .user-attendanceR-detail .time{display:inline-block;width:225px; text-align: center;}
        ...
        <div class="rightBox">
            ...
            <?php
                ...
                while ($row=mysqli_fetch_array($result)) {
                    if ($row[0] != 'course_sign' && $row[0] != 'student_sign' && $row[0] != 'logs'){
            ?>
            <div class="user-attendanceR-list ">
                <div class="user-attendanceR-detail">
                    <?php for($i = 0; $i < $num ; $i++) { ?>
                    ...
                    <?php }?>
                    <span class="time"><a href="add.php?table=<?php echo $row[0];?>" target="_self" class="btn-attendance" style="margin-left: 50px;" >增加</a></span>
                    <span class="time"><a href="del.php?table=<?php echo $row[0];?>" target="_self" class="btn-attendance" style="margin-left: 50px;" >删除</a></span>
                    <span class="time"><a href="alt.php?table=<?php echo $row[0];?>" target="_self" class="btn-attendance" style="margin-left: 50px;" >修改</a></span>
                </div>
            </div>
            <?php } }?>
        </div>
