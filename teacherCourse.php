...
<div class="checkWorkContent clearfix">
	...
	<div class="checkConMiddle">
		<div class="rightTitle"><h1>开设课程</h1></div>
		<div class="rightBox">
			<div class="user-attendanceR-list">
				<div class="user-attendanceR-detail">
                    ...
                    <span class="time" style="width: 250px;">操作</span>
				</div>
			</div>
			<?php
			...
			<div class="user-attendanceR-list ">
				<div class="user-attendanceR-detail">
                    ...
                    <?php }?>
					<a href="sign_teacher.php?cid=<?php echo $row['cid'];?>" target="_self" class="btn-attendance" style="margin-left: 50px;" >考勤</a>
                    <a href="recordAction.php?cid=<?php echo $row['cid'];?>" target="_self" class="btn-attendance" style="margin-left: 50px;" >考勤记录</a>
				</div>
			</div>
			<?php }?>
		</div>
