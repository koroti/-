...
date_default_timezone_set('Asia/Shanghai');
    ...
    $user = $_COOKIE['user'];
    $table = $_GET['table'];
    setcookie("opera","insert",time()+3600);
    setcookie("table",$table,time()+3600);
    if(empty($id)){
...
<style type="text/css">
    ...
    .user-attendanceR-detail .time{display:inline-block;width:120px; text-align: center;}
...
<div class="checkWorkContent clearfix">
    ...
    <div class="checkConMiddle">
        <div class="rightTitle"><h1>增添</h1></div>
        <div class="rightBox">
                <?php
                    include 'conn.php';
                ...
                <?php }?>
                <table>
                    <form id="form1" name="form1" action="rootresult.php" method="post" >
                    <?php 
                    include "conn.php";
                    ...
                    ?>
                    <tr>
                    <td><input type="submit" id="edit" name="Submit" value="提  交"/></td>
                    </form> 
                    </tr>
            </table>
        </div>
